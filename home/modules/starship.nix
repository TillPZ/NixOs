{ ... }:
{
  programs.starship = {
    ...
    settings = {
      ...
      format = "[](surface0)$username$hostname[](bg:surface1 fg:surface0)$directory[](fg:surface1)";

      right_format = "(bg:surface0 fg:lavender)$cmd_duration$jobs$status$c$rust$golang$nodejs$php$java$kotlin$haskell$python$git_branch$git_status[](fg:surface1) ";
